...
## Recap — Where We Just Were   (bridge from [[Hardware Faults]])
...
## Level 2 — How It Actually Works   (mechanism + ONE mermaid diagram; why software faults are correlated unlike hardware faults)
...
## Level 3 — See It With Real Numbers   (a concrete scenario from the note)
The book's flagship example is the **leap second** bug. Occasionally the world's official clocks add one extra second to keep in step with Earth's rotation. On **June 30, 2012**, that extra second exposed a bug in the Linux kernel that made many machines hang at the same instant. The assumption baked into the code was roughly: "a minute always has 60 seconds." True for years. Then one minute had 61, and services across the internet froze together.

A tiny timeline of how a dormant bug bites:

```
2011 ......... code written, assumes 60-second minutes
2011-2012 .... runs perfectly, bug never triggered (dormant)
2012-06-30 ... leap second added -> assumption is now false
